# /ship integration via Stop hook (Phase 2 — NOT IN v0.1.0)
...
Concrete Stop hook JSON template will be added to this file when v0.2 ships. Until then: manual invocation only.
